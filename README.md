...
**Lifecycle category:** registry listed flow surface
**Normative source:** Riverbraid-Core
**Claim boundary:** Declared Conditions Only

## Role in Riverbraid

Riverbraid-Flow-Gold provides flow state and transition verification support within Riverbraid.

This repository is a bounded flow-oriented surface. It does not define canonical Riverbraid protocol semantics or certify system-wide flow correctness.
...
This repository does not claim certification, legal approval, production readiness, absolute security, external audit, complete AI safety, adoption, registry freshness, vulnerability freedom, security hardening, or absence of defects.
